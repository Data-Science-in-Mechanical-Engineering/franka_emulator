...
namespace FRANKA_EMULATOR
{
    namespace emulator
    {
        ...
        static const double gripper_stiffness = 10.0;
        static const double gripper_damping = 6.0;
        static const double gripper_move_epsilon = 0.001;
        static const unsigned int gripper_history_size = 500;
        static const double gripper_stuck_treshold = 0.001;
